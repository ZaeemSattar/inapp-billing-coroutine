...
class KotlinSampleActivity : AppCompatActivity() {
    ...
    private fun initializeBillingClient() {
        ...
        billingManager.setBillingEventListener(object : BillingEventListener {
    ...
    private fun clickListeners() {
        ...
        purchaseConsumable.setOnClickListener {
            billingManager.purchase(this, "consumable_id1")
        }
        purchaseNonConsumable.setOnClickListener {
            billingManager.purchase(this, "non_consumable_id2")
        }

        //purchase a subscription
        purchaseSubscription.setOnClickListener {
            billingManager.subscribe(this, "subscription_id3")
        }

        //cancel a subscription
        cancelSubscription.setOnClickListener {
            billingManager.unsubscribe(this, "subscription_id3")
        }
   ...
   * */
    ...
    private fun usefulPublicMethods() {
        ...
        * */
        when (billingManager.isSubscriptionSupported) {
        ...
        for (skuInfo in fetchedSkuInfoList) {
            when (billingManager.isPurchased(skuInfo)) {
                PurchasedResult.YES -> {
                    //TODO - do something
